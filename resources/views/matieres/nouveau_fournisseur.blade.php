...
@section('page-title', 'Ajouter un nouveau fournisseur')
...
<div class="card shadow">
    ...
    <div class="card-body">
        <form action="{{ route('matieres.enregistrerFournisseur') }}" method="POST">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('personne_contact') is-invalid @enderror" id="personne_contact" name="personne_contact" value="{{ old('personne_contact') }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('telephone_contact') is-invalid @enderror" id="telephone_contact" name="telephone_contact" value="{{ old('telephone_contact') }}">
